...
echo "$ME: Processing Contest based Cabrillo file into log platforms (LT7D)" 2>&1 | tee -a $tmpFile

#python3 ./postLdA.py cbrData.adi 2>&1 | tee -a $tmpFile
#python3 ./postEQSL.py cbrData.adi 2>&1 | tee -a $tmpFile
./postClubLog_LT7D.sh cbrData.adi 2>&1 | tee -a $tmpFile
./postHRDLog.sh cbrData.adi 2>&1 | tee -a $tmpFile
